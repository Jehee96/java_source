...
public class Ex33_DtoTest {
	private ArrayList<Ex33_DonDto> list = new ArrayList<Ex33_DonDto>();
	...
	public void inputData(String[] datas) {
		for(String s:datas) {
			...
			Ex33_DonDto dto = new Ex33_DonDto(sabun, name, gibon, ipsa);
			list.add(dto);
		}	
	}
	...
	public static void main(String[] args) {
		...
		Ex33_DtoTest test = new Ex33_DtoTest();
