...
//				strs += oneline + "\n";			// 문자열 더하기는 비권장
	...
	public static void main(String[] args) {
		...
		File file = new File("c:/Workstation/Acorn/iotest02.txt");

		Ex35_IoTest03 test02 = new Ex35_IoTest03();
		test02.write_file(file, list);
		test02.read_file(file);
	}
